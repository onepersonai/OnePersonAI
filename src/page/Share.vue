...
<template>
  <div class="MatcShareDialog" @keydown.stop @keyup.stop @keypress.stop>
    ...
    <div class="field MatcShareRow">
      ...
      <a class="MatcShareIcon" :href="testLink" target="_OnePersonAITest">
    ...
    <div class="field MatcShareRow">
      ...
      <a class="MatcShareIcon" :href="shareLink" target="_OnePersonAIShare">
        <span class="mdi mdi-share" />
      </a>
    </div>
    ...
    <div class="field MatcShareRow">
      ...
      <a class="MatcShareIcon" @click="copy" target="_OnePersonAIShare">
