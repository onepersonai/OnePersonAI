    ...
    methods: {
      ...
      async writeToGit () {
        ...
        try {
          ...
          await repository.writeFile(this.github.branch, fileName, JSON.stringify(this.model, null, 2), 'OnePersonAI Export')
                ...
                reader.onloadend = () => {
                  ...
                  var base64result = reader.result.substr(reader.result.indexOf(',') + 1);
                   ...
                   //content = content.replace(/^(.+,)/, '');
                    ...
                    repository.writeFile(this.github.branch, fileName, base64result, 'OnePersonAI Export').then(result => {
                      resolve(result)
                    })
                }
