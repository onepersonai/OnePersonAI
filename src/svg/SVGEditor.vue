<template>
  <div
    :class="
        'opai-svg-editor opai-svg-editor_cursor_' +
        cursor +
        (!isBoundingBoxVisible ? ' opai-svg-editor-no-bbox' : '')"
    ...
    <svg id="svg" xmlns="http://www.w3.org/2000/svg" :width="width" :height="height">
        ...
        <g id="main" fill="none">
            ...
            <line :x1="zoomedSnappLineX" y1="0" :x2="zoomedSnappLineX" :y2="height" class="opai-svg-snapp-line-x"  v-if="hasSnappLineX"/>

            <line :x1="0" :y1="zoomedSnappLineY" :x2="width" :y2="zoomedSnappLineY" class="opai-svg-snapp-line-y"  v-if="hasSnappLineY"/>
            ...
            <template v-if="showHover">
                <path v-for="p in paths"
                    :key="p.id + 's'"
                    :d="p.d"
                    class="opai-svg-editor-click-line"
            ...
            <template v-if="splitPoints">
                <circle v-for="(splitPoint,i) in splitPoints" :key="'sp' + i"
                    ...
                    class="opai-svg-editor-splitpoint"
                    :r="splitPoint.r" />
            </template>
            ...
            <template v-if="showAllBezierPoints">
                <path v-for="p in allBezierPoints.lines"
                    ...
                    class="opai-svg-editor-beziee-line opai-svg-editor-beziee-line-debug"
                    fill=""
                    :stroke-width="1"/>
                ...
                <rect v-for="bezierpoint in allBezierPoints.points"
                    ...
                    :class="['opai-svg-editor-bezier opai-svg-editor-bezier-debug', {'opai-svg-editor-bezier-selected': selectedBezier && bezierpoint.id === selectedBezier.id}]"
                    />
            </template>
            ...
            <template v-if="showJoints">
                ...
                <path v-for="p in selectedBezierElements.lines"
                    ...
                    :d="p.d"
                    stroke="rgba(0,0,0,0.4)"
                    class="opai-svg-editor-beziee-line"
                    fill=""
                    :stroke-width="1"/>
                ...
                <rect v-for="bezierpoint in selectedBezierElements.points"
                    ...
                    :class="[
                        'opai-svg-editor-bezier ',
                        {'opai-svg-editor-bezier-x1': bezierpoint.isX1},
                        {'opai-svg-editor-bezier-selected': selectedBezier && bezierpoint.id === selectedBezier.id}
                    ]"
                    />
                ...
                <circle v-for="joint in joints" :key="joint.id"
                    ...
                    :class="['opai-svg-editor-joint', {'opai-svg-editor-joint-selected': joint.selected}]"
                    :r="joint.r" />
            ...
            <rect v-if="selectBox"
                    ...
                    class="opai-svg-editor-select-box" />
            ...
            <template v-if="boundingBox">
                ...
                <rect
                    ...
                    class="opai-svg-editor-bounding" />
                <!-- handlers rectangle-->
                <circle
                    ...
                    :class="'opai-svg-editor-resize-handler ' + handler.type" />
            </template>
...
<style>
  @import url("../style/opai-svg-editor.css");
</style>
