...
class UserService extends AbstractService{
    ...
    logout () {
        ...
        Cookies.remove('quxUserLoggedIn', { path: '/' , domain: 'onepersonai.com'})
    ...
    setUser (u) {
        ...
        Cookies.set('quxUserLoggedIn', JSON.stringify(u), { domain: 'onepersonai.com', expires: 7, secure: true, path:'/'}) 
    }
