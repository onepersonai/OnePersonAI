export let texts = [
  {
      ...
      "title": "User Surveys",
      "body": `
          When users test a OnePersonAI prototype, the user input is saved. For instance, a Star Rating that they are giving is stored.
          ...
          OnePersonAI comes with many elements that can be used to collect direct user feedback. In the widget menu in the design canvas,
