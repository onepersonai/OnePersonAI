export let texts = [
    {
        ...
        "title": "Import",
        "body": `
           You can import images (png, jpg) or Figma projects into OnePersonAI.
        `,
        "paragraphs": [
            {
                "id": "import.bitmap",
                "title": "Image Import",
                "body": `
                    You can import PNG and JPEG files from other tools into OnePersonAI. Simply drag and drop them on the canvas,
            ...
            },
            {
                ...
                "body": `
                    You can import Figma projects into OnePersonAI by opening the Import wizard. Before you start you need to create an Access key:
