export let texts = [
    {
        ...
        "paragraphs": [
            ...
            },
            {
                ...
                "title": "Basics",
                "body": `
                    The script has access to OnePersonAI objects, the "data" binding and the "qux" object.
...
if (data.valueA * 1 < 100) {
    ...
    widget.setStyle({color: 'black'})  
                    ...
                    <p class="MatcHelpCallout">
                        OnePersonAI follows the standard JavaScript way of set CSS styles. For instance, the 
